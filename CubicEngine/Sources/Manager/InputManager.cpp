...
void CubicEngine::Input::InputManager::FrameTick(float elapsedTime)
{
...
bool CubicEngine::Input::InputManager::GetKeyPress(KeyCode key)
{
...
bool CubicEngine::Input::InputManager::GetKeyRelease(KeyCode key)
{
